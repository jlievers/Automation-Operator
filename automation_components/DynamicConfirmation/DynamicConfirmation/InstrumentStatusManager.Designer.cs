...
{
	partial class InstrumentStatusManager
	{
		/// <summary>
		...
		private void InitializeComponent()
		{
			...
			this.dataGridView1.Size = new System.Drawing.Size(244, 348);
			this.dataGridView1.TabIndex = 0;
			// 
			// instrumentName
			// 
			this.instrumentName.HeaderText = "Instruments";
			...
			// 
			// InstrumentStatusManager
			// 
			this.AutoScaleDimensions = new System.Drawing.SizeF(6F, 13F);
			this.AutoScaleMode = System.Windows.Forms.AutoScaleMode.Font;
			this.ClientSize = new System.Drawing.Size(269, 375);
			this.Controls.Add(this.dataGridView1);
			this.Name = "InstrumentStatusManager";
			this.Text = "InstrumentStatusManager";
