...
namespace DLL_VersoAPI
{
    public static class VersoAPI
    {
    }
    ...
    public class JobResultHistoryDataResponse
    {
        public List<JobResultHistoryData> Items { get; set; }
        public int SkippedItems { get; set; }
        public int TakenItems { get; set; }
        public int CountedItems { get; set; }
    }

    public class JobResultHistoryData
    {
        public string ContainerId { get; set; }
        public List<ContainerBarcodeIdentifier> Identifiers { get; set; }
        public string LabwareDefinitionId { get; set; }
        public string LabwareType { get; set; }
        public string JobResultId { get; set; }
        public string JobId { get; set; }
        public string ResultClassifiers { get; set; }
    ...
    public class ContainerSearch // all inputs are optional but since this is a post null values are not returned
    {
    ...
    public class IntroducedRackLog
    {
        public List<IntroducedRack> rack_list { get; set; }
    }

        public class IntroducedRack
    {
        public string barcode { get; set; }
        public string assay { get; set; }
        public bool consolodated { get; set; }
        public string verso_introduce_timestamp { get; set; }
        public string introduce_type { get; set; }
        public string rack_scanfile_name { get; set; }
        public bool tubes_added_to_lib { get; set; }
    }
}
