    ...
    public static class LIMSCalls
    {
        ...
        private static string InitExtractionBatching_backup(string LIMSEndpoint, string SystemFolderPath, string RunID, string tubeRackID, string LMNumber, string dataTable)
        {
            ...
            try
            {
                ...
                DatafileUploadResponse responseObj = ser.Deserialize<DatafileUploadResponse>(DLL_Http.Http.SendJSONToAPI(ser.Serialize(myPayload), RunID, runOutputFolder, apiAddress, "msg", "5213155e-87af-4db1-96f7-47fd89f96c57", 120000, "Upload Extraction Tube Map"));
            ...
            try
            {
                ...
                DLL_LIMS_Workflow.TasksQueryResponseV2 responseObj = ser.Deserialize<DLL_LIMS_Workflow.TasksQueryResponseV2>(LIMSReturnText);
                DLL_LIMS_Workflow.LIMS_Workflow.ReadErrorsInResponse(responseObj.errors);
            ...
            try
            {
                ...
                DLL_LIMS_Workflow.WorkflowPayload myPayload = new DLL_LIMS_Workflow.WorkflowPayload();
                ...
                DLL_LIMS_Workflow.LIMSResponse responseObj = ser.Deserialize<DLL_LIMS_Workflow.LIMSResponse>(DLL_Http.Http.SendJSONToAPI(ser.Serialize(myPayload), RunID, runOutputFolder, apiAddress, "msg", "5213155e-87af-4db1-96f7-47fd89f96c57", 120000, "Initialize Extraction Batch Selection Workflow"));
                DLL_LIMS_Workflow.LIMS_Workflow.ReadErrorsInResponse(responseObj.errors);
            ...
            try
            {
                ...
                DLL_LIMS_Workflow.TasksQueryResponseV2 responseObj = ser.Deserialize<DLL_LIMS_Workflow.TasksQueryResponseV2>(DLL_Http.Http.HttpGet(apiAddress, RunID, runOutputFolder, "msg", "5213155e-87af-4db1-96f7-47fd89f96c57", 120000, "Get Pending Extraction Tasks"));
                DLL_LIMS_Workflow.LIMS_Workflow.ReadErrorsInResponse(responseObj.errors);
                foreach (DLL_LIMS_Workflow.TasksQueryResponse_DataV2 myData in responseObj.data)
                {
            ...
            try
            {
                ...
                DLL_LIMS_Workflow.LIMSResponse responseObj = ser.Deserialize<DLL_LIMS_Workflow.LIMSResponse>(DLL_Http.Http.SendJSONToAPI(ser.Serialize(myPayload), RunID, runOutputFolder, apiAddress, "msg", "5213155e-87af-4db1-96f7-47fd89f96c57", 360000, "Initialize Extraction Workflow"));
                DLL_LIMS_Workflow.LIMS_Workflow.ReadErrorsInResponse(responseObj.errors);
            ...
            try
            {
                ...
                DLL_LIMS_Workflow.StepPayload myPayload = new DLL_LIMS_Workflow.StepPayload();
                ...
                DLL_LIMS_Workflow.LIMSResponse responseObj = ser.Deserialize<DLL_LIMS_Workflow.LIMSResponse>(DLL_Http.Http.SendJSONToAPI(ser.Serialize(myPayload), RunID, runOutputFolder, apiAddress, "msg", "5213155e-87af-4db1-96f7-47fd89f96c57", 120000, "Initialize Extraction Step: RNA Extraction"));
                DLL_LIMS_Workflow.LIMS_Workflow.ReadErrorsInResponse(responseObj.errors);
            }
            catch (Exception ex)
            {
        ...
        public static void voidvalidateIBs(string LIMSEndpoint, string SystemFolderPath, string RunID, string[] myIBs, out string[] invalidIBs)
        {
            ...
            SpecimenResponse responseObj = ser.Deserialize<SpecimenResponse>(DLL_Http.Http.SendJSONToAPI(ser.Serialize(myPayload), RunID, runOutputFolder, apiAddress, "weblims", "206b5ebc-ce82-4bd0-ae9d-b0b943b5fa1a", 120000, "Validate Tube Barcodes For Extraction"));
        ...
        public static void CompleteExtraction(string LIMSEndpoint, string SystemFolderPath, string RunID, string extractionWorkflowID)
        {
            ...
            try
            {
                ...
                DLL_LIMS_Workflow.LIMSResponse responseObj = ser.Deserialize<DLL_LIMS_Workflow.LIMSResponse>(DLL_Http.Http.SendJSONToAPI(ser.Serialize(myPayload), RunID, runOutputFolder, apiAddress, "msg", "5213155e-87af-4db1-96f7-47fd89f96c57", 120000, "Complete Extraction Step: RNA Extraction"));
                DLL_LIMS_Workflow.LIMS_Workflow.ReadErrorsInResponse(responseObj.errors);
            }
            catch (Exception ex)
            {
        ...
        public static string InitQuantification(string LIMSEndpoint, string SystemFolderPath, string RunID, string extractionWorkflowID, string tubeRackID, string LMNumber, string picoDyePlate, string picoStandardPlate, string quantification_workflow)
        {
            ...
            try
            {
                ...
                string apiAddress = "https://" + LIMSEndpoint + "/api/lab_workflow/v1/upload-datafile/";
                DatafileUploadResponse responseObj = ser.Deserialize<DatafileUploadResponse>(DLL_Http.Http.SendJSONToAPI(ser.Serialize(myPayload), RunID, runOutputFolder, apiAddress, "msg", "5213155e-87af-4db1-96f7-47fd89f96c57", 120000, "Upload Quant Tube Map"));
                DLL_LIMS_Workflow.LIMS_Workflow.ReadErrorsInResponse(responseObj.errors);
            ...
            try
            {
                ...
                DLL_LIMS_Workflow.TasksQueryResponseV2 responseObjExtractionTasks = ser.Deserialize<DLL_LIMS_Workflow.TasksQueryResponseV2>(DLL_Http.Http.HttpGet(apiAddress, RunID, runOutputFolder, "msg", "5213155e-87af-4db1-96f7-47fd89f96c57", 120000, "Get Pending Quant Tasks"));
                DLL_LIMS_Workflow.LIMS_Workflow.ReadErrorsInResponse(responseObjExtractionTasks.errors);
                foreach (DLL_LIMS_Workflow.TasksQueryResponse_DataV2 myData in responseObjExtractionTasks.data)
                {
            ...
            try
            {
                ...
                if (request_id != "")
                {
                    ...
                    string apiAddress = "https://" + LIMSEndpoint + "/api/lab_workflow/v1/initialize-workflow/";
                    DLL_LIMS_Workflow.LIMSResponse responseObj = ser.Deserialize<DLL_LIMS_Workflow.LIMSResponse>(DLL_Http.Http.SendJSONToAPI(ser.Serialize(myPayload), RunID, runOutputFolder, apiAddress, "msg", "5213155e-87af-4db1-96f7-47fd89f96c57", 120000, "Initialize Quantification Workflow"));
                    DLL_LIMS_Workflow.LIMS_Workflow.ReadErrorsInResponse(responseObj.errors);
            ...
            try
            {
                ...
                string apiAddress = "https://" + LIMSEndpoint + "/api/lab_workflow/v1/initialize-step/";
                DLL_LIMS_Workflow.LIMSResponse responseObj = ser.Deserialize<DLL_LIMS_Workflow.LIMSResponse>(DLL_Http.Http.SendJSONToAPI(ser.Serialize(myPayload), RunID, runOutputFolder, apiAddress, "msg", "5213155e-87af-4db1-96f7-47fd89f96c57", 120000, "Initialize Quantification Step: RNA Quantification"));
                DLL_LIMS_Workflow.LIMS_Workflow.ReadErrorsInResponse(responseObj.errors);
            }
            catch (Exception ex)
            {
        ...
        public static void CompleteQuantification(string LIMSEndpoint, string SystemFolderPath, string RunID, string quantificationWorkflowID, string readerFileName)
        {
            ...
            try
            {
                ...
                string apiAddress = "https://" + LIMSEndpoint + "/api/lab_workflow/v1/complete-step/";
                DLL_LIMS_Workflow.LIMSResponse responseObj = ser.Deserialize<DLL_LIMS_Workflow.LIMSResponse>(DLL_Http.Http.SendJSONToAPI(ser.Serialize(myPayload), RunID, runOutputFolder, apiAddress, "msg", "5213155e-87af-4db1-96f7-47fd89f96c57", 120000, "Complete Quantification Step: RNA Quantification"));
                DLL_LIMS_Workflow.LIMS_Workflow.ReadErrorsInResponse(responseObj.errors);
            }
            catch (Exception ex)
            {
        ...
        public static void CheckPendingNormTask(string LIMSEndpoint, string SystemFolderPath, string RunID, string quantificationWorkflowID)
        {
            ...
            try
            {
                ...
                DLL_LIMS_Workflow.TasksQueryResponseV2 responseObjExtractionTasks = ser.Deserialize<DLL_LIMS_Workflow.TasksQueryResponseV2>(DLL_Http.Http.HttpGet(apiAddress, RunID, runOutputFolder, "msg", "5213155e-87af-4db1-96f7-47fd89f96c57", 120000, "Get Pending Normalization Tasks"));
                DLL_LIMS_Workflow.LIMS_Workflow.ReadErrorsInResponse(responseObjExtractionTasks.errors);
                foreach (DLL_LIMS_Workflow.TasksQueryResponse_DataV2 myData in responseObjExtractionTasks.data)
                {
        ...
        public static string InitNormalization(string LIMSEndpoint, string SystemFolderPath, string RunID, string quantificationWorkflowID, string tubeRackID, string LMNumber, string normalization_workflow, string nucleaseFreeWater)
        {
            ...
            try
            {
                ...
                string apiAddress = "https://" + LIMSEndpoint + "/api/lab_workflow/v1/upload-datafile/";
                DatafileUploadResponse responseObj = ser.Deserialize<DatafileUploadResponse>(DLL_Http.Http.SendJSONToAPI(ser.Serialize(myPayload), RunID, runOutputFolder, apiAddress, "msg", "5213155e-87af-4db1-96f7-47fd89f96c57", 120000, "Upload Normalization Tube Map"));
                DLL_LIMS_Workflow.LIMS_Workflow.ReadErrorsInResponse(responseObj.errors);
                mapfile = responseObj.data.data_file;
            }
            catch (Exception ex)
            ...
            try
            {
                if (request_id != "")
                {
                    ...
                    string apiAddress = "https://" + LIMSEndpoint + "/api/lab_workflow/v1/initialize-workflow/";
                    DLL_LIMS_Workflow.LIMSResponse responseObj = ser.Deserialize<DLL_LIMS_Workflow.LIMSResponse>(DLL_Http.Http.SendJSONToAPI(ser.Serialize(myPayload), RunID, runOutputFolder, apiAddress, "msg", "5213155e-87af-4db1-96f7-47fd89f96c57", 120000, "Initialize RNA Normalization Workflow"));
                    DLL_LIMS_Workflow.LIMS_Workflow.ReadErrorsInResponse(responseObj.errors);
            ...
            try
            {
                ...
                string apiAddress = "https://" + LIMSEndpoint + "/api/lab_workflow/v1/initialize-step/";
                DLL_LIMS_Workflow.LIMSResponse responseObj = ser.Deserialize<DLL_LIMS_Workflow.LIMSResponse>(DLL_Http.Http.SendJSONToAPI(ser.Serialize(myPayload), RunID, runOutputFolder, apiAddress, "msg", "5213155e-87af-4db1-96f7-47fd89f96c57", 120000, "Initialize Workflow Step: RNA Normalization"));
                DLL_LIMS_Workflow.LIMS_Workflow.ReadErrorsInResponse(responseObj.errors);
            }
            catch (Exception ex)
            {
        ...
        public static string GetNormalizationWorklist(string LIMSEndpoint, string SystemFolderPath, string RunID, string normalization_workflow)
        {
            ...
            {
                //Get Norm Worklist
                DLL_LIMS_Workflow.GetMaterialPayload myPayload = new DLL_LIMS_Workflow.GetMaterialPayload();
                myPayload.material_name = "norm_worklist";
                myPayload.workflow = normalization_workflow;

                string apiAddress = "https://" + LIMSEndpoint + "/api/lab_workflow/v1/material/";
                DLL_LIMS_Workflow.GetMaterialResponse responseObj = ser.Deserialize<DLL_LIMS_Workflow.GetMaterialResponse>(DLL_Http.Http.SendJSONToAPI(ser.Serialize(myPayload), RunID, runOutputFolder, apiAddress, "msg", "5213155e-87af-4db1-96f7-47fd89f96c57", 120000, "Get RNA Normalization Worklist"));
                DLL_LIMS_Workflow.LIMS_Workflow.ReadErrorsInResponse(responseObj.errors);
        ...
        public static void CompleteNormalization(string LIMSEndpoint, string SystemFolderPath, string RunID, string normilizationWorkflowID)
        {
            ...
            try
            {
               //Complete RNA Normalization Step1
                ...
                string apiAddress = "https://" + LIMSEndpoint + "/api/lab_workflow/v1/complete-step/";
                DLL_LIMS_Workflow.LIMSResponse responseObj = ser.Deserialize<DLL_LIMS_Workflow.LIMSResponse>(DLL_Http.Http.SendJSONToAPI(ser.Serialize(myPayload), RunID, runOutputFolder, apiAddress, "msg", "5213155e-87af-4db1-96f7-47fd89f96c57", 120000, "Complete RNA Normalization Workflow Step: Normalization"));
                DLL_LIMS_Workflow.LIMS_Workflow.ReadErrorsInResponse(responseObj.errors);
            }
            catch (Exception ex)
            {
        ...
        public static string InitRetrieveAndStamp(string LIMSEndpoint, string SystemFolderPath, string RunID, string normilizationWorkflowID, string tubeRackID, string LMNumber,string assay_plate_id, string retrieve_and_stamp_workflow)
        {
            ...
            try
            {
                ...
                string apiAddress = "https://" + LIMSEndpoint + "/api/lab_workflow/v1/upload-datafile/";
                DatafileUploadResponse responseObj = ser.Deserialize<DatafileUploadResponse>(DLL_Http.Http.SendJSONToAPI(ser.Serialize(myPayload), RunID, runOutputFolder, apiAddress, "msg", "5213155e-87af-4db1-96f7-47fd89f96c57", 120000, "Upload RNA Retrieve And Stamp Tube Map"));
                DLL_LIMS_Workflow.LIMS_Workflow.ReadErrorsInResponse(responseObj.errors);
                mapfile = responseObj.data.data_file;
            }
            catch (Exception ex)
            ...
            try
            {
                ...
                DLL_LIMS_Workflow.TasksQueryResponseV2 responseObjExtractionTasks = ser.Deserialize<DLL_LIMS_Workflow.TasksQueryResponseV2>(DLL_Http.Http.HttpGet(apiAddress, RunID, runOutputFolder, "msg", "5213155e-87af-4db1-96f7-47fd89f96c57", 120000, "Get Pending RNA Retrieve And Stamp Tasks"));
                DLL_LIMS_Workflow.LIMS_Workflow.ReadErrorsInResponse(responseObjExtractionTasks.errors);
                foreach (DLL_LIMS_Workflow.TasksQueryResponse_DataV2 myData in responseObjExtractionTasks.data)
                {
            ...
            try
            {
                if (request_id != "")
                {
                    ...
                    string apiAddress = "https://" + LIMSEndpoint + "/api/lab_workflow/v1/initialize-workflow/";
                    DLL_LIMS_Workflow.LIMSResponse responseObj = ser.Deserialize<DLL_LIMS_Workflow.LIMSResponse>(DLL_Http.Http.SendJSONToAPI(ser.Serialize(myPayload), RunID, runOutputFolder, apiAddress, "msg", "5213155e-87af-4db1-96f7-47fd89f96c57", 120000, "Initialize RNA Retrieve And Stamp Workflow"));
                    DLL_LIMS_Workflow.LIMS_Workflow.ReadErrorsInResponse(responseObj.errors);
            ...
            try
            {
                ...
                string apiAddress = "https://" + LIMSEndpoint + "/api/lab_workflow/v1/initialize-step/";
                DLL_LIMS_Workflow.LIMSResponse responseObj = ser.Deserialize<DLL_LIMS_Workflow.LIMSResponse>(DLL_Http.Http.SendJSONToAPI(ser.Serialize(myPayload), RunID, runOutputFolder, apiAddress, "msg", "5213155e-87af-4db1-96f7-47fd89f96c57", 120000, "Initialize Workflow Step: RNA Retrieve And Stamp"));
                DLL_LIMS_Workflow.LIMS_Workflow.ReadErrorsInResponse(responseObj.errors);
            }
            catch (Exception ex)
            {
        ...
        public static void CompleteRetrieveAndStamp(string LIMSEndpoint, string SystemFolderPath, string RunID, string retrieveAndStampWorkflowID)
        {
            ...
            try
            {
                ...
                string apiAddress = "https://" + LIMSEndpoint + "/api/lab_workflow/v1/complete-step/";
                DLL_LIMS_Workflow.LIMSResponse responseObj = ser.Deserialize<DLL_LIMS_Workflow.LIMSResponse>(DLL_Http.Http.SendJSONToAPI(ser.Serialize(myPayload), RunID, runOutputFolder, apiAddress, "msg", "5213155e-87af-4db1-96f7-47fd89f96c57", 120000, "Complete RNA Retrieve And Stamp step1"));
                DLL_LIMS_Workflow.LIMS_Workflow.ReadErrorsInResponse(responseObj.errors);
            }
            catch (Exception ex)
            {
